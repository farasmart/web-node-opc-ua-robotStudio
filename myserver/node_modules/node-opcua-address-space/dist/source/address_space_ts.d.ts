...
import { Argument, ArgumentOptions, AxisInformationOptions, AxisScaleEnumeration, BrowsePath, BrowsePathResult, BuildInfo, CallMethodResultOptions, DataTypeDefinition, EUInformation, EUInformationOptions, PermissionType, Range, RangeOptions, ReferenceDescription, RolePermissionType, RolePermissionTypeOptions, ServerDiagnosticsSummaryDataType, ServerState, ServerStatusDataType, SessionDiagnosticsDataType, SessionSecurityDiagnosticsDataType, SignedSoftwareCertificate, SimpleAttributeOperand } from "node-opcua-types";
...
export declare class BaseNode extends EventEmitter {
    ...
    readonly accessRestrictions?: AccessRestrictionsFlag;
    ...
    getChildByName(browseName: QualifiedNameLike): BaseNode | null;
...
export declare class UAMethod extends BaseNode {
     ...
     * @param callback
     */
    execute(object: UAObject | UAObjectType | null, inputArguments: VariantLike[] | null, context: SessionContext, callback: MethodFunctorCallback): void;
...
export declare class UAReferenceType extends BaseNode {
     ...
     * @param reference
     */
    checkHasSubtype(referenceType: NodeId | Reference): boolean;
}
